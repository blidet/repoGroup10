...
public class RepoCommitJSONParser extends AsyncTask<HttpResponse, Void, ArrayList<EventPOJO>> {
	...
	public RepoCommitJSONParser(TheListFragment context, boolean loadMore){
